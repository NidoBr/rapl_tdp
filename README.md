...
### Usa como base o '/sys/class/powercap/intel-rapl\:0/energy_uj', que mede o consumo total em micro joules, e usando um calculo simples é possivel obter o valor atual em Watts, pelos meus testes tem um bom nivel de precisão.
